...
def _close_all_session_windows():
    ...
    for name in ['log', 'editor', 'history', 'mode_c']:
        _close_win(name)
...
def _make_fixed_builders():
    ...
    return {
        ...
        0x2A7:b2A7, 0x2EC:b2EC, 0x294:b294,
...
def open_log_window():
    ...
    def _build():
        ...
        win.title('📡 实时发送日志  —  CAN Sender v3.0')
...
def open_editor_window():
    ...
    def _build():
        ...
        win.title('🔧 在线帧编辑器  —  CAN Sender v3.0')
...
def open_history_window():
    ...
    def _build():
        ...
        win.title('🔍 历史帧筛选  —  CAN Sender v3.0')
...
def open_pcan_info_window():
    ...
    def _build():
        ...
        win.title('🔌 PCAN 占用查看  —  CAN Sender v3.0')
...
def build_fixed_sender_specs(builders):
    return [
        ...
        (0x0AB, builders[0x0AB], 0.075, "0AB"),
...
def select_mode():
    ...
    print(f"{BOLD}{WHITE}  PCAN Sender v3.2  ·  GitHub: JackieZ123430{RESET}")
    print(f"{BOLD}{CYAN}{'═'*70}{RESET}\n")
